...
## 📌 Overview
This repository contains Selenium WebDriver automation work, including **practice exercises** and **two key projects**:

1. **EMI Calculator (Capstone Project)**  
...
2. **Parabank Website (Hackathon Project)**  
