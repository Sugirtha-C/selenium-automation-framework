...
/**
 * Test class for verifying EMI and total payment values for home loan calculations based on tenure.
 * 
 * This class uses TestNG to execute tests that validate EMI and total payment calculations based on the provided
 * loan tenure data in years. It includes setup and teardown methods for initializing and closing the WebDriver, 
 * and captures screenshots for validation and error handling.
 * 
 */
@Listeners(TestListeners.class)
public class HomeLoanEmiWithTenureTests {
    ...
    /**
     * Sets up the test environment by initializing WebDriver, page objects, and utility classes.
    ...
    /**
     * Tests the EMI and total payment calculations with different tenures in years.
     * 
     * This test performs the following steps:
     * - Opens the home loan calculator website.
     * - Enters the loan amount and tenure in years.
     ...
     * - The input excel sheet handles both valid and invalid input values
     * 
     *
     * @param loanAmount the amount of the loan
     * @param termInYears the tenure of the loan in years
     ...
     */
    @Test(dataProvider="CalcEmiWithTenureAsYears", dataProviderClass=DataProviderUtility.class)
    public void verifyEmiValuesWithYearsTenureInYears(String loanAmount, String termInYears, String expectedLoanEMI, String expectedTotalPayment) throws InterruptedException {
        ...
        try {
            ...
            try {
            	...
            	commonSteps.clickFieldUsingJavaScript(homeLoanCalc.homeLoanAmount);
            	commonSteps.clearFieldUsingJavaScript(homeLoanCalc.homeLoanAmount);
            	homeLoanCalcSteps.enterLoanAmount(loanAmount);
            	
            	commonSteps.clickFieldUsingJavaScript(homeLoanCalc.homeLoanTermInput);
            	commonSteps.clearFieldUsingJavaScript(homeLoanCalc.homeLoanTermInput);
                homeLoanCalcSteps.enterLoanTenure(termInYears);

            } catch (Exception e) {
                // Take a screenshot after entering the details
                screenshotUtility.takeScreenshot("HomeLoanTestWithTenure", "LoanDetails_" + loanAmount + "_" + termInYears);
            ...
            try {
                ...
                screenshotUtility.takeScreenshot("Error Screenshots", "RetrievedValuesErrors_" + loanAmount + "_" + termInYears);
            ...
            try {
                ...
                screenshotUtility.takeScreenshot("Error Screenshots", "AssertionErrors_" + loanAmount + "_" + termInYears);
                throw e;
            }

            try {
                // Take a screenshot after validation
                screenshotUtility.takeScreenshot("HomeLoanResults", "Results_" + loanAmount + "_" + termInYears);
            ...
            screenshotUtility.takeScreenshot("Error Screenshots", "GeneralErrors_" + loanAmount + "_" + termInYears);
